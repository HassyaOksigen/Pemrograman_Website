...
function App() {
  ...
  // STATE BARU: Menyimpan ID Alat yang dipilih dari katalog Supabase
    ...
    <div className={`app-wrapper ${isModalOpen ? "modal-open" : ""}`}>
      ...
      {session && role === "admin" ? (
        ...
        <>
          ...
          {page === "rent-form" && (
            <RentForm setPage={handleNavigation} session={session} rentData={rentFormData} setRentData={setRentFormData} />
          )}
